...
const FooterAffordances = (props) => {
    ...
    return (
        <div className="footer-affordances">
            ...
            <a className="footer-affordance-light footer-affordance-underline" href="#">
                education rate
            </a>
...
export default FooterAffordances